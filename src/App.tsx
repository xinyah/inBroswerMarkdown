		...
		<div className="container">
			...
			<div className="input">
				...
				<p className="input-main">
					...
					Nobis et repudiandae, asperiores harum incidunt dignissimos
					enim nulla dicta, ratione, illo eum ad nostrum cum dolores
					accusamus voluptas magnam ipsa! Similique?
				</p>
			</div>
			<div className="input right">
				...
				<p className="input-main">
					...
					Eaque quos saepe earum sint sunt delectus? Dignissimos nobis
					facilis ipsam numquam aut magni. Placeat.
				</p>
			</div>
		</div>
	);
